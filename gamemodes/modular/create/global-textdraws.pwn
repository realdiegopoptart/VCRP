	...
	TextDrawColor(gServerTextdraws[0], 0xAAC4E5FF);
	...
	gServerTextdraws[1] = TextDrawCreate(564.000000, 3.000000, " ");
	TextDrawAlignment(gServerTextdraws[1], 2);
	TextDrawBackgroundColor(gServerTextdraws[1], 255);
	TextDrawFont(gServerTextdraws[1], 3);
	TextDrawLetterSize(gServerTextdraws[1], 0.300000, 1.370000);
	TextDrawColor(gServerTextdraws[1], -1);
	TextDrawSetOutline(gServerTextdraws[1], 0);
	...
	BlackBox = TextDrawCreate(-20.000000,2.000000,"|");
    TextDrawUseBox(BlackBox,1);
    TextDrawBoxColor(BlackBox,0x000000ff);
    TextDrawTextSize(BlackBox,660.000000,22.000000);
    TextDrawAlignment(BlackBox,0);
    TextDrawBackgroundColor(BlackBox,0x000000ff);
    TextDrawFont(BlackBox,3);
    TextDrawLetterSize(BlackBox,1.000000,52.200000);
    TextDrawColor(BlackBox,0x000000ff);
    TextDrawSetOutline(BlackBox,1);
